...
cv2.createTrackbar('Hue Low','myTracker',22,180,onTrack1)
cv2.createTrackbar('Hue High','myTracker',25,180,onTrack2)
 
cv2.createTrackbar('Hue Low2','myTracker',59,180,onTrack7)
cv2.createTrackbar('Hue High2','myTracker',72,180,onTrack8)
 
cv2.createTrackbar('Sat Low','myTracker',137,255,onTrack3)
